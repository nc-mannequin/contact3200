        ...
        <div class="ui start aligned grid">
          <div class="column">
            <h2 class="ui teal image header">
              <div class="content">
                <span class="ui large black text">Contact <span class="ui green label">Add</span></span>
              </div>
            </h2>
  ...
  export default {
    ...
    methods: {
      onSubmitClick() {
        ...
        axios.post('https://contact-lists-assignment-62-130-200.azurewebsites.net/contacts', data, { withCredentials: true })
          .then(() => {
            this.$router.push('/');
          })
          .catch((error) => {
